...
const Faq = () => {
  ...
  return (
    <div className='faq-outer'>
       <nav className='nav'>
        <Link to='/'><img src='/images/Logonav.png' alt="logo"/></Link>
        <ul className={click? 'navList active':'navList'} >
          <li>
            <Link to='/' style={{cursor:'pointer',textDecoration:'none' }} className='nav-link'>About</Link>  
          </li>
          <li>
          <Link className='nav-link' style={{cursor:'pointer',textDecoration:'none' }} to='/token-allocation'>Tokenomics</Link>
          </li>
          <li>
    ...
    <div className='faq-inner'>
        ...
        <h2 className='grobold' style={{color:'#582900',textAlign:'center'}}>Frequently Asked Questions</h2>
        <div className='faq-main'>
        <div className='faq-main1'>
        <p className='grobold'>When was Carlossy Caterpillar founded?</p>
        <FaArrowRight style={{cursor:'pointer'}} onClick={handleShow}/>
        </div>
        {showfaq && <div className='faq-main1'>Q4 of 2021, October. </div>}
        <div className='faq-main1'>
        <p className='grobold'>What is Carlossy Caterpillar's vision?</p>
        <FaArrowRight style={{cursor:'pointer'}}onClick={handleShow2}/>
        </div>
        {showfaq2 && <div className='faq-main1'>To create more spaces for people who want to be involved in the digital world to combine their interests with a way of earning.</div>}
        <div className='faq-main1'>
        <p className='grobold'>How much is a Carlossy Caterpillar's token worth?</p>
        <FaArrowRight style={{cursor:'pointer'}}onClick={handleShow3}/>
        </div>
        {showfaq3 && <div className='faq-main1'>$0.06 </div>}        
        <div className='faq-main1'>
        <p className='grobold'>Was Carlossy Caterpillar inspired by the M&S and Aldi dispute?</p>
        <FaArrowRight style={{cursor:'pointer'}} onClick={handleShow4}/>
        </div>
        {showfaq4 && <div className='faq-main1'>Yes It was</div>}
        </div>
        </div>
